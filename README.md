...
# RMIH (Resources Management Integrated Human)

### Platform Operasional Bisnis & SDM Terpadu (HR, Presensi, Payroll, Multi-Sektor)

**RMIH** (berbasis Leopardo RH engine) adalah platform operasional modular open-source untuk pengelolaan personalia, presensi lapangan, penggajian otomatis, manajemen keuangan, serta integrasi multi-sektor industri.
...
**SDM & Penggajian · Presensi GPS & Biometrik · Akuntansi · CRM Klien · Pemasaran · Aplikasi Mobile · Open API**

[Portal Web](http://localhost:3000) · [Admin Dashboard](http://localhost:3001) · [Dokumentasi](docs/README.md) · [Arsitektur](ARCHITECTURE.md) · [API](api/openapi.yaml) · [Keamanan](SECURITY.md)
