  ...
  >
    ...
    <div class="flex h-20 shrink-0 items-center justify-center border-b border-slate-200/50 dark:border-slate-800/50 px-6">
      <div class="flex items-center">
        <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-brand-600 to-indigo-600 shadow-lg shadow-brand-500/20">
          <img src="/brand/rmih-emblem.png" alt="RMIH" class="w-7 h-7 object-contain" />
        </div>
        <span class="ml-3 text-xl font-black tracking-tight text-slate-900 dark:text-white">RMIH <span class="text-brand-500 font-bold text-sm">Admin</span></span>
      </div>
    </div>
