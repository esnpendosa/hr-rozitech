...
import { getCopy, getPreferredLocale, getStoredUser, toIntlLocale, type AppLocale } from '@/lib/i18n';
...
export default function PayrollPage() {
  ...
  const formatCurrency = (val: number) => {
    ...
    const currency = storedUser?.company?.currency || 'IDR';
    return new Intl.NumberFormat(toIntlLocale(locale), { style: 'currency', currency }).format(val || 0);
  };
