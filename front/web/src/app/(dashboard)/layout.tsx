        ...
        <div className="flex h-16 shrink-0 items-center justify-between gap-3 border-b border-slate-200/50 px-5">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="truncate text-sm font-black tracking-tight text-slate-950">{user?.company?.name ?? 'RMIH'}</p>
              <p className="truncate text-[10px] font-black uppercase tracking-widest text-blue-700">{labels.dashboard.businessSection}</p>
            </div>
          </div>
          <button
            type="button"
          ...
          <div className="flex h-16 items-center justify-between gap-4 px-4 md:px-8">
            <div className="flex min-w-0 items-center gap-3">
              {business.length > 0 ? (
                <button
                  type="button"
                  className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-600 shadow-sm transition hover:border-blue-300 hover:text-blue-700 md:hidden"
                  aria-label={labels.dashboard.businessSection}
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            {navEntries.length > 0 ? (
              <div className="relative lg:hidden">
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-600 shadow-sm transition hover:border-blue-300 hover:text-blue-700"
                >
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs font-bold text-slate-600 shadow-sm transition hover:border-blue-300 hover:text-blue-700"
              >
                    ...
                    {platformModules.length > 0 ? platformModules.map((module) => (
                      <div key={module.key} className="flex items-center justify-between gap-2 text-[12px] font-bold text-slate-600">
                        ...
                        <span className={`rounded-lg border px-2 py-0.5 text-[9px] font-black uppercase tracking-widest ${
                          module.enabled ? 'border-blue-200 bg-blue-50 text-blue-700' : 'border-slate-200 bg-slate-100 text-slate-500'
                        }`}>
