...
export const modulePageContent = {
  employes: {
    ...
    solution: {
      ...
      description: "RMIH automatise et centralise chaque aspect de la gestion de vos employés, de la paie aux absences.",
      features: [
        {
    ...
    testimonials: {
      ...
      items: [
        {
          quote: "RMIH a transformé notre gestion RH. Nous avons économisé 10h par semaine!",
          author: "Marie Dupont",
          role: "Manager RH",
  ...
  documents: {
    ...
    solution: {
      ...
      description: "RMIH offre un cabinet numérique avec chiffrement AES-256, permissions granulaires et outils de conformité RGPD.",
      features: [
        {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "RMIH applique des mesures de protection des données (chiffrement, isolation par société, registre des traitements) et fournit les exports/suppressions prévus par le RGPD. Voir notre politique de confidentialité pour le détail.",
        },
        {
          question: "Quel est le délai de mise en place?",
  ...
  comptabilite: {
    ...
    solution: {
      ...
      description: "RMIH automatise tous les calculs de paie, génère les bulletins et exporte directement vers votre comptabilité.",
      features: [
        {
  ...
  marketing: {
    ...
    solution: {
      ...
      description: "RMIH offre email, SMS, réseaux sociaux et analytics intégrés à votre plateforme RH.",
      features: [
        {
...
const modulePageContentEn: Partial<ModulePageContent> = {
  employes: {
    ...
    solution: {
      ...
      description: 'RMIH automates and centralizes every aspect of managing your employees, from payroll to absences.',
      features: [
    ...
    testimonials: {
      ...
      items: [
        {
          quote: 'RMIH transformed our HR management. We save 10 hours a week!',
          author: 'Marie Dupont',
          role: 'HR Manager',
          company: 'TechStartup Inc',
          avatar: '/avatars/marie.svg',
  ...
  documents: {
    ...
    solution: {
      ...
      description: "RMIH offers a digital cabinet with AES-256 encryption, granular permissions and GDPR compliance.",
      features: [
        {
  ...
  comptabilite: {
    ...
    solution: {
      ...
      description: "RMIH automates all payroll calculations, generates payslips and exports directly to your accounting.",
      features: [
        {
  ...
  marketing: {
    ...
    solution: {
      ...
      description: "RMIH offers email, SMS, social networks and analytics integrated with your HR platform.",
      features: [
        {
          title: "Email Marketing",
          description: "Templates, segmentation, automation, A/B testing",
...
const modulePageContentTr: Partial<ModulePageContent> = {
  employes: {
    ...
    solution: {
      title: 'RMIH Bu Sorunları Nasıl Çözer',
      subtitle: 'Tüm İK yönetiminiz için merkezi bir platform',
      description: 'RMIH, bordrodan izinlere kadar çalışan yönetiminizin her yönünü otomatikleştirir ve merkezileştirir.',
      features: [
    ...
    testimonials: {
      ...
      items: [
        {
          quote: 'RMIH İK yönetimimizi dönüştürdü. Haftada 10 saat tasarruf ediyoruz!',
          author: 'Marie Dupont',
          role: 'İK Müdürü',
          company: 'TechStartup Inc',
          avatar: '/avatars/marie.svg',
  ...
  comptabilite: {
    ...
    solution: {
      ...
      description: "RMIH tüm bordro hesaplamalarını otomatikleştirir, bordroları oluşturur ve doğrudan muhasebenize aktarır.",
      features: [
        {
