...
const caseStudySeoByLocale: Record<AppLocale, Record<string, CaseStudySeo>> = {
  fr: {
    startup: {
      ...
      description:
        "Comment une startup technologique a structuré pointage, absences et paie de 5 à 50 employés avec RMIH, sans recruter de profil RH dédié.",
    },
    retail: {
      title: 'Pointage centralisé pour une chaîne de 50 magasins',
      description:
        'Une chaîne de 50 points de vente centralise le pointage de 500 employés, réduit les écarts de paie et fiabilise ses plannings avec RMIH.',
    },
    factory: {
    ...
    'law-firm': {
      ...
      description:
        "Un cabinet d'avocats centralise ses dossiers RH confidentiels, contrôle les accès et trace chaque consultation pour ses audits avec RMIH.",
    },
    'hr-files': {
    ...
    'sme-payroll': {
      ...
      description:
        'Une PME en croissance passe de trois jours à deux heures de paie mensuelle et supprime les erreurs de calcul sur deux pays grâce à RMIH.',
    },
    'startup-advances': {
  ...
  en: {
    startup: {
      ...
      description:
        'How a technology startup structured attendance, leave and payroll while scaling from 5 to 50 employees with RMIH, without a dedicated HR hire.',
    },
    retail: {
      title: 'Centralized time tracking for a 50-store retail chain',
      description:
        'A 50-store retail chain centralizes attendance for 500 employees, cuts payroll discrepancies and makes shift planning reliable with RMIH.',
    },
    factory: {
    ...
    'law-firm': {
      ...
      description:
        'A law firm centralizes its confidential HR files, controls access and traces every consultation for compliance audits with RMIH.',
    },
    'hr-files': {
    ...
    'sme-payroll': {
      ...
      description:
        'A growing SMB cuts monthly payroll from three days to two hours and removes payroll calculation errors across two countries with RMIH.',
    },
    'startup-advances': {
