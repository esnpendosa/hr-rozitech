...
const legalPages: Record<AppLocale, Record<LegalPageKind, LegalPageCopy>> = {
  fr: {
    privacy: {
      ...
      intro:
        'RMIH traite des données RH sensibles pour aider les entreprises a piloter le pointage, la paie, les absences et les workflows terrain. Cette page explique notre approche de protection, de transparence et de controle.',
      ...
      sections: [
        ...
        },
        {
          title: 'Sécurité',
          body: [
            'RMIH applique l isolation multi-tenant, le controle d accès par roles, la journalisation des accès sensibles et une logique de moindre privilege.',
    ...
    terms: {
      ...
      intro:
        'Ces conditions encadrent l utilisation de RMIH par les entreprises, administrateurs, managers, employés, kiosques et integrateurs autorises.',
      updatedAt: 'Dernière mise a jour : 14 mai 2026',
      backLabel: 'Retour à l’accueil',
      languageLabel: 'Langue du document',
      sections: [
        {
          ...
          body: [
            'L accès est reserve aux utilisateurs autorises par une entreprise cliente ou par RMIH pour l’administration de la plateforme.',
        ...
        },
        {
          ...
          body: [
            'RMIH peut faire evoluer les modules, APIs et interfaces pour ameliorer la sécurité, la performance et la valeur produit.',
  ...
  en: {
    privacy: {
      ...
      intro:
        'RMIH processes sensitive HR data to help companies run attendance, payroll, leave and field workflows. This page explains our approach to protection, transparency and control.',
      ...
      sections: [
        ...
        },
        {
          title: 'Security',
          body: [
            'RMIH applies tenant isolation, role-based access control, sensitive data access logging and least-privilege principles.',
    ...
    terms: {
      ...
      title: 'Terms of use',
      intro:
        'These terms govern the use of RMIH by companies, administrators, managers, employees, kiosks and authorized integrators.',
      updatedAt: 'Last updated: May 14, 2026',
      backLabel: 'Back to home',
      languageLabel: 'Document language',
      sections: [
        {
          ...
          body: [
            'Access is limited to users authorized by a customer company or by RMIH for platform administration.',
        ...
        },
        {
          ...
          body: [
            'RMIH may evolve modules, APIs and interfaces to improve security, performance and product value.',
  ...
  tr: {
    privacy: {
      ...
      intro:
        'RMIH, sirketlerin devam, bordro, izin ve saha is akışlarini yonetmesine yardim etmek icin hassas IK verilerini isler. Bu sayfa koruma, seffaflik ve kontrol yaklasimimizi aciklar.',
      ...
      sections: [
        ...
        },
        {
          title: 'Guvenlik',
          body: [
            'RMIH tenant izolasyonu, rol tabanli erisim kontrolu, hassas veri erisim gunlugu ve en az ayricalik ilkelerini uygular.',
    ...
    terms: {
      ...
      intro:
        'Bu kosullar RMIH nin sirketler, yoneticiler, mudurler, calisanlar, kiosklar ve yetkili entegratorler tarafindan kullanimini duzenler.',
      updatedAt: 'Son guncelleme: 14 Mayis 2026',
      backLabel: 'Ana sayfaya don',
      languageLabel: 'Belge dili',
      sections: [
        {
          ...
          body: [
            'Erisim, musteri sirket tarafindan veya platform yonetimi icin RMIH tarafindan yetkilendirilen kullanicilarla sinirlidir.',
        ...
        },
        {
          ...
          body: [
            'RMIH guvenlik, performans ve urun degerini artirmak icin modulleri, API leri ve arayuzleri gelistirebilir.',
  ...
  ar: {
    privacy: {
      ...
      intro:
        'تعالج RMIH بيانات موارد بشرية حساسة لمساعدة الشركات على إدارة الحضور والرواتب والإجازات وسير العمل الميداني. توضح هذه الصفحة نهجنا في الحماية والشفافية والتحكم.',
      ...
      sections: [
        ...
        },
        {
          title: 'الأمان',
          body: [
            'تطبق RMIH عزل المستأجرين والتحكم في الوصول حسب الأدوار وتسجيل الوصول إلى البيانات الحساسة ومبدأ أقل صلاحية.',
    ...
    terms: {
      ...
      intro:
        'تنظم هذه الشروط استخدام RMIH من قبل الشركات والمسؤولين والمديرين والموظفين وأجهزة الكشك والمكاملين المعتمدين.',
      updatedAt: 'آخر تحديث: 14 مايو 2026',
      backLabel: 'العودة إلى الصفحة الرئيسية',
      languageLabel: 'لغة الوثيقة',
      sections: [
        {
          ...
          body: [
            'يقتصر الوصول على المستخدمين المصرح لهم من شركة عميلة أو من RMIH لإدارة المنصة.',
        ...
        },
        {
          ...
          body: [
            'قد تطور RMIH الوحدات وواجهات API والواجهات لتحسين الأمان والأداء وقيمة المنتج.',
