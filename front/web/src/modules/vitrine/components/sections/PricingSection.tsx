        ...
        >
          {badge && (
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/[0.08] border border-blue-500/15 text-blue-700 dark:text-blue-400 text-sm font-semibold mb-6">
              {badge.icon && <span className="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse" />}
              {badge.text}
            </div>
          )}
        ...
        {showToggle && (
          ...
          >
            ...
            <button
              ...
              style={{
                backgroundColor: isAnnual ? 'rgb(37, 99, 235)' : undefined,
              }}
            >
              <motion.div
                layout
            ...
            {isAnnual && (
              <motion.span
                ...
                className="ml-2 px-3 py-1 rounded-full bg-emerald-500/10 text-blue-700 dark:text-blue-400 text-xs font-bold"
              >
                -20%
              </motion.span>
            )}
