...
const highlightByLocale: Record<AppLocale, HighlightTestimonial> = {
  id: {
    quote: 'Sejak menggunakan RMIH, kami menghemat hingga 40% waktu administrasi personalia. Penggajian multi-cabang dan absensi biometrik mentransformasi operasional harian kami.',
    name: 'Amina Diallo',
    role: 'Direktur Sumber Daya Manusia',
    company: 'Perusahaan Teknologi · 350 karyawan, 3 cabang',
    avatar: 'AD',
  },
  fr: {
    quote: "Depuis que nous utilisons RMIH, nous avons reduit de 40% le temps consacre a l'administration RH. La paie multi-pays et le pointage biometrique ont transforme nos operations.",
    name: 'Amina Diallo',
  ...
  en: {
    quote: "Since adopting RMIH, we cut HR admin time by 40%. Multi-country payroll and biometric attendance transformed our day-to-day operations across three offices.",
    name: 'Amina Diallo',
    role: 'HR Director',
  ...
  tr: {
    quote: "RMIH'yi kullanmaya basladigimizdan beri IK yonetim surelerimizi %40 azalttik. Cok ulkeli bordro ve biyometrik devam takibi operasyonlarimizi donusturdu.",
    name: 'Amina Diallo',
    role: 'IK Direktoru',
  ...
  ar: {
    quote: "منذ اعتمادنا RMIH، خفضنا وقت إدارة الموارد البشرية بنسبة 40%. الرواتب متعددة البلدان والحضور البيومتري غيّرا عملياتنا اليومية.",
    name: 'Amina Diallo',
...
export function TestimonialHighlight({ locale = 'id' }: TestimonialHighlightProps) {
  const testimonial = highlightByLocale[locale] ?? highlightByLocale.id ?? highlightByLocale.fr;
    ...
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <Quote className="w-12 h-12 text-blue-200 dark:text-blue-900/50 mb-6" />
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white text-lg font-black">
                {testimonial.avatar}
              </div>
              <div>
