...
const copyByLocale: Record<AppLocale, Copy> = {
  id: {
    title: 'Dirancang untuk Sektor Industri Anda',
    subtitle: 'RMIH dipercaya oleh perusahaan lintas sektor yang membutuhkan manajemen absensi presisi, penggajian otomatis, dan operasional lapangan yang andal.',
    sectorLabels: {
      industry: 'Manufaktur & Pabrik',
      energy: 'Energi & Konstruksi',
      finance: 'Keuangan & Jasa',
      aviation: 'Penerbangan & Transportasi',
      telecom: 'Telekomunikasi',
      retail: 'Ritel & Distribusi',
  ...
  fr: {
    ...
    subtitle: 'RMIH s\u2019adresse aux entreprises de Turquie, d\u2019Afrique du Nord, d\u2019Europe, d\u2019Afrique et du Monde Arabe qui ont besoin de paie multi-pays et de pointage terrain fiable.',
    sectorLabels: {
      industry: 'Industrie',
      energy: 'Energie & BTP',
  ...
  en: {
    ...
    subtitle: 'RMIH serves companies across Turkey, North Africa, Europe, Africa and the Arab World that need multi-country payroll and reliable field attendance.',
    sectorLabels: {
  ...
  tr: {
    ...
    subtitle: 'RMIH, cok ulkeli bordro ve guvenilir saha devam takibine ihtiyaci olan Turkiye, Kuzey Afrika, Avrupa, Afrika ve Arap Dunyasindaki sirketlere hizmet verir.',
    sectorLabels: {
      industry: 'Uretim',
  ...
  ar: {
    title: 'مصمم لقطاعك',
    subtitle: 'يخدم RMIH الشركات في تركيا وشمال أفريقيا وأوروبا وأفريقيا والعالم العربي التي تحتاج إلى رواتب متعددة البلدان وحضور ميداني موثوق.',
    sectorLabels: {
      industry: 'الصناعة',
...
function SectorCard({ sector, label }: { sector: Sector; label: string }) {
  ...
  return (
    <div className="flex-shrink-0 mx-3">
      <div className="flex items-center gap-3 px-5 py-3 rounded-xl border bg-gradient-to-br from-blue-500/10 to-indigo-500/5 border-blue-500/20 backdrop-blur-sm hover:scale-105 transition-transform duration-300">
