        ...
        >
          {resolvedPrimaryCta && (
            <Link
              ...
              className="group relative px-8 py-4 bg-white text-blue-600 font-bold rounded-2xl overflow-hidden transition-all duration-300 cta-glow-white hover:scale-[1.03] active:scale-[0.98]"
            >
