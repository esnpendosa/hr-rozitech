...
export function FeatureCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative h-full bg-white dark:bg-slate-900/80 backdrop-blur-sm rounded-3xl border border-slate-200/80 dark:border-slate-800/80 p-8 transition-all duration-300 group-hover:border-blue-200/50 dark:group-hover:border-blue-800/50 group-hover:shadow-xl ${
          isHighlighted ? 'bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20' : ''
        }`}
      >
        {/* Icon + Stats */}
