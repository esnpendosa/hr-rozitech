...
const copyByLocale: Record<AppLocale, Copy> = {
  id: {
    title: 'Lihat RMIH Beraksi',
    subtitle: 'Portal web, dasbor admin, dan aplikasi mobile karyawan — tangkapan langsung dari produk.',
    playLabel: 'Putar video demo produk',
    captionLabelFr: 'Bahasa Indonesia',
  },

  fr: {
    title: 'Voyez RMIH en action',
  ...
  tr: {
    title: "RMIH'yi is basinda gorun",
