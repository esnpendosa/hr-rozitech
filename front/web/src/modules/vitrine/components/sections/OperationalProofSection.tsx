...
const copyByLocale: Record<AppLocale, ProofCopy> = {
  id: {
    ...
    title: 'Satu platform untuk menjual, menghubungkan, dan mengoperasikan',
    subtitle: 'Situs publik, portal klien, admin platform, aplikasi mobile karyawan/manajer/admin, dan kiosk biometrik dirancang sebagai satu sistem operasional terpadu.',
    primary: 'Mulai 14 Hari Uji Coba Gratis',
    secondary: 'Lihat Demo',
    proofs: [
      { title: '3 Aplikasi Mobile', detail: 'Karyawan, Manajer/HR, dan Platform Admin dengan alur kerja khusus.' },
      { title: '2 Aplikasi Web', detail: 'Website pemasaran dan ruang kerja klien/admin terhubung ke API yang sama.' },
      { title: 'Kiosk & Biometrik', detail: 'Presensi lapangan ZKTeco, QR, dan dukungan offline-first.' },
      { title: 'API Produksi', detail: 'Health, OpenAPI, pengujian profil, dan tata kelola rilis.' },
    ],
  },
  fr: {
...
export function OperationalProofSection({ locale }: OperationalProofSectionProps) {
  ...
  return (
    <section className="px-4 py-16 sm:px-6 lg:px-8" dir={isRtl ? 'rtl' : 'ltr'}>
      <div className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] border border-blue-200/70 bg-slate-950 text-white shadow-2xl shadow-blue-950/20 dark:border-blue-900/60">
        <motion.div
      ...
      >
          <div className="p-8 sm:p-10 lg:p-14">
            <div className="inline-flex items-center gap-2 rounded-full border border-blue-400/30 bg-blue-400/10 px-4 py-2 text-sm font-semibold text-blue-200">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-blue-600 px-5 py-3 text-sm font-bold text-slate-950 transition hover:bg-blue-500"
              >
                {copy.primary}
          ...
          <div className="border-t border-white/10 bg-white/[0.03] p-6 sm:p-8 lg:border-l lg:border-t-0">
            <div className="mb-5 flex items-center gap-3 text-blue-200">
              ...
              <span className="text-sm font-semibold uppercase tracking-[0.24em]">RMIH stack</span>
            </div>
              ...
              {copy.proofs.map((proof, i) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="mt-0.5 h-5 w-5 flex-none text-blue-400" />
                    <div>
