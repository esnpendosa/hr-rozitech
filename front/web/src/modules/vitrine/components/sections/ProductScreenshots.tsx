...
const screensByLocale: Record<AppLocale, { badge: string; title: string; titleHighlight: string; screens: ProductScreen[] }> = {
  id: {
    badge: 'Antarmuka',
    title: 'Satu platform,',
    titleHighlight: 'di semua perangkat',
    screens: [
      {
        icon: <Monitor className="w-6 h-6" />,
        title: 'Dasbor Admin',
        description: 'Pusat kendali lengkap untuk memantau SDM: KPI kinerja, absensi real-time, penggajian, dan laporan analitik.',
        features: ['KPI Real-Time', 'Penggajian Otomatis', 'Manajemen Karyawan', 'Ekspor CSV/PDF/Excel'],
        gradient: 'from-blue-600 to-indigo-600',
        mockup: 'desktop',
        screenshotSrc: '/screenshots/web-dashboard.png',
        screenshotAlt: 'Tampilan dasbor admin RMIH',
      },
      {
        icon: <Smartphone className="w-6 h-6" />,
        title: 'Aplikasi Mobile',
        description: 'Karyawan dan manajer dapat melakukan presensi GPS, cek slip gaji, dan mengajukan cuti langsung dari ponsel.',
        features: ['Absensi GPS & Selfie', 'Slip Gaji Digital', 'Pengajuan Cuti & Izin', 'Notifikasi Cepat'],
        gradient: 'from-violet-500 to-purple-500',
        mockup: 'mobile',
        screenshotSrc: '/screenshots/mobile-attendance.png',
        screenshotAlt: 'Tampilan layar presensi aplikasi mobile RMIH',
      },
      {
        icon: <TabletSmartphone className="w-6 h-6" />,
        title: 'Kiosk Absensi ZKTeco',
        description: 'Terminal mandiri di lokasi kantor/pabrik untuk absensi wajah, kartu RFID, dan pengumuman perusahaan.',
        features: ['Presensi Biometrik Wajah', 'Pengumuman Perusahaan', 'QR Code Karyawan', 'Dukungan Mode Offline'],
    ...
    screens: [
      {
        ...
        mockup: 'desktop',
        screenshotSrc: '/screenshots/web-dashboard.png',
        screenshotAlt: 'Capture du dashboard admin RMIH',
      },
      {
        icon: <Smartphone className="w-6 h-6" />,
        title: 'App Mobile',
    ...
    screens: [
      {
        ...
        mockup: 'desktop',
        screenshotSrc: '/screenshots/web-dashboard.png',
        screenshotAlt: 'RMIH admin dashboard screenshot',
      },
      {
        icon: <Smartphone className="w-6 h-6" />,
        title: 'Mobile App',
    ...
    screens: [
      {
        ...
        mockup: 'desktop',
        screenshotSrc: '/screenshots/web-dashboard.png',
        screenshotAlt: 'RMIH IK yonetici paneli ekran goruntusu',
      },
      {
        icon: <Smartphone className="w-6 h-6" />,
    ...
    screens: [
      {
        ...
        mockup: 'desktop',
        screenshotSrc: '/screenshots/web-dashboard.png',
        screenshotAlt: 'لقطة شاشة للوحة تحكم الإدارة في روزيتك للموارد البشرية',
      },
      {
        icon: <Smartphone className="w-6 h-6" />,
        title: 'تطبيق الجوال',
