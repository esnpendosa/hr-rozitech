...
export function DemoSection() {
  ...
  const miniStats = [
    { icon: Users, ...copy.demo.miniStats[0], color: 'text-blue-500' },
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="gsap-reveal">
            ...
            <div className="space-y-4">
              {copy.demo.highlights.map((item, index) => (
                ...
                >
                  <div className="w-8 h-8 rounded-xl bg-blue-500/10 flex items-center justify-center group-hover:bg-blue-500/20 transition-colors duration-300">
          ...
          <motion.div style={{ y: imgY }} className="gsap-reveal">
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-r from-blue-500/20 to-indigo-500/20 rounded-3xl blur-2xl opacity-40" />
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-slate-200/50 dark:border-slate-700/50 bg-white dark:bg-slate-900">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="bg-transparent dark:bg-slate-800/50 rounded-xl p-4 aspect-[2/1] flex items-center justify-center">
                    <BarChart3 className="w-16 h-16 text-blue-300 dark:text-blue-800" />
                  </div>
                </div>
              </div>
            </div>
