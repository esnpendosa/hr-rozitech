  ...
  fr: {
    ...
    openings: {
      ...
      items: [
        ...
        { title: 'Customer Success Manager', department: 'Customer Success', location: 'Paris', type: 'CDI', description: "Accompagnez nos clients dans l'adoption de RMIH." },
  ...
  en: {
    ...
    openings: {
      ...
      items: [
        ...
        { title: 'Customer Success Manager', department: 'Customer Success', location: 'Paris', type: 'Full-time', description: 'Support our clients in adopting RMIH.' },
  ...
  tr: {
    ...
    openings: {
      ...
      items: [
        ...
        { title: 'Müşteri Başarı Yöneticisi', department: 'Müşteri Başarısı', location: 'Paris', type: 'Tam zamanlı', description: 'Müşterilerimize RMIH benimsenmesinde eşlik edin.' },
