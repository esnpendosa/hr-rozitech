  ...
  fr: [
    {
      ...
      solution: 'Déploiement de bornes ZKTeco + module pointage RMIH avec synchronisation automatique vers la paie.',
      results: [
    ...
    },
    {
      ...
      solution: 'Migration vers RMIH multi-tenant avec paie multi-pays (barèmes fiscaux locaux) et tableau de bord consolidé.',
      results: [
  ...
  en: [
    {
      ...
      solution: 'Deployment of ZKTeco terminals + RMIH attendance module with automatic payroll synchronization.',
      results: [
    ...
    },
    {
      ...
      solution: 'Migration to multi-tenant RMIH with multi-country payroll (local tax scales) and a consolidated dashboard.',
      results: [
  ...
  tr: [
    {
      ...
      solution: 'ZKTeco terminalleri + maaş ile otomatik senkronizasyonlu RMIH devam modülü.',
      results: [
    ...
    },
    {
      ...
      solution: 'Çok ülkeli maaş (yerel vergi dilimleri) ve konsolide panel ile çok kiracılı RMIH geçişi.',
      results: [
  ...
  ar: [
    {
      ...
      solution: 'نشر أجهزة ZKTeco + وحدة الحضور في RMIH مع مزامنة تلقائية مع الرواتب.',
      results: [
    ...
    },
    {
      ...
      solution: 'الانتقال إلى RMIH متعدد المستأجرين مع رواتب متعددة الدول (شرائح ضريبية محلية) ولوحة تحكم موحدة.',
      results: [
...
export const caseStudyUiCopy: Record<AppLocale, {
  ...
  fr: {
    ...
    moduleExplore: 'Découvrez comment RMIH couvre ce besoin au quotidien, ou explorez les autres études de cas.',
    discoverModule: 'Découvrir {module}',
    ctaDescription: 'Rejoignez les entreprises qui ont choisi RMIH',
  ...
  en: {
    ...
    moduleExplore: 'Discover how RMIH covers this need day to day, or explore other case studies.',
    discoverModule: 'Discover {module}',
    ctaDescription: 'Join the companies that chose RMIH',
  ...
  tr: {
    ...
    moduleExplore: 'RMIH’nin bu ihtiyacı günlük olarak nasıl karşıladığını keşfedin veya diğer vaka çalışmalarına göz atın.',
    discoverModule: '{module} modülünü keşfedin',
    ctaDescription: 'RMIH’yi seçen şirketlere katılın',
  ...
  ar: {
    ...
    moduleExplore: 'اكتشف كيف تغطي RMIH هذه الحاجة يومياً، أو استكشف دراسات الحالة الأخرى.',
    discoverModule: 'اكتشف {module}',
    ctaDescription: 'انضم إلى الشركات التي اختارت RMIH',
