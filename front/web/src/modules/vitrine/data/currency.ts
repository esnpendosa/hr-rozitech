...
export type CurrencyCode = 'IDR' | 'EUR' | 'DZD' | 'MAD' | 'TND' | 'TRY' | 'CAD' | 'USD'

export type CountryCode = 'ID' | 'FR' | 'DZ' | 'MA' | 'TN' | 'TR' | 'CA' | 'US'
 ...
 */
export const PRICING_CURRENCY: CurrencyCode = 'IDR'
...
export type CurrencyOption = {
  ...
  label: Record<'id' | 'fr' | 'en' | 'tr' | 'ar', string>
}
...
export const CURRENCY_OPTIONS: CurrencyOption[] = [
  {
    ...
    currency: 'IDR',
    rateFromEur: 17000,
    label: { id: 'Indonesia (Rp)', fr: 'Indonésie (IDR)', en: 'Indonesia (IDR)', tr: 'Endonezya (IDR)', ar: 'إندونيسيا (روبية)' },
  },
  {
    country: 'FR',
    currency: 'EUR',
    rateFromEur: 1,
    label: { id: 'Prancis (EUR)', fr: 'France (EUR)', en: 'France (EUR)', tr: 'Fransa (EUR)', ar: 'فرنسا (يورو)' },
  },
  {
    country: 'DZ',
    currency: 'DZD',
    rateFromEur: 148,
    label: { id: 'Aljazair (DZD)', fr: 'Algerie (DZD)', en: 'Algeria (DZD)', tr: 'Cezayir (DZD)', ar: 'الجزائر (دينار)' },
  },
  {
    country: 'MA',
    currency: 'MAD',
    rateFromEur: 10.8,
    label: { id: 'Maroko (MAD)', fr: 'Maroc (MAD)', en: 'Morocco (MAD)', tr: 'Fas (MAD)', ar: 'المغرب (درهم)' },
  },
  {
    country: 'TN',
    currency: 'TND',
    rateFromEur: 3.4,
    label: { id: 'Tunisia (TND)', fr: 'Tunisie (TND)', en: 'Tunisia (TND)', tr: 'Tunus (TND)', ar: 'تونس (دينار)' },
  },
  {
    country: 'TR',
    currency: 'TRY',
    rateFromEur: 39,
    label: { id: 'Turki (TRY)', fr: 'Turquie (TRY)', en: 'Turkey (TRY)', tr: 'Turkiye (TRY)', ar: 'تركيا (ليرة)' },
  },
  {
    country: 'CA',
    currency: 'CAD',
    rateFromEur: 1.55,
    label: { id: 'Kanada (CAD)', fr: 'Canada (CAD)', en: 'Canada (CAD)', tr: 'Kanada (CAD)', ar: 'كندا (دولار كندي)' },
  },
  {
    country: 'US',
    currency: 'USD',
    rateFromEur: 1.08,
    label: { id: 'Amerika Serikat (USD)', fr: 'Etats-Unis (USD)', en: 'United States (USD)', tr: 'ABD (USD)', ar: 'الولايات المتحدة (دولار)' },
  },
]
