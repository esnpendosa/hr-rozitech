...
export const docsCategoriesCopy: Record<AppLocale, DocsCategory[]> = {
  fr: [
    {
      ...
      color: 'emerald',
      items: [
        { title: 'Introduction', desc: "Vue d'ensemble de RMIH — Mobile-First Company OS", href: '/docs#intro' },
    ...
    },
    {
      ...
      color: 'violet',
      items: [
        { title: 'RMIH Employee', desc: 'Pointage, demandes, bulletin, notifications push', href: '/docs#sdk-overview' },
        { title: 'RMIH Manager', desc: 'Équipe, horaires, taches, approbations', href: '/docs#sdk-overview' },
  ...
  en: [
    {
      ...
      color: 'emerald',
      items: [
        { title: 'Introduction', desc: 'RMIH overview — Mobile-First Company OS', href: '/docs#intro' },
    ...
    },
    {
      ...
      color: 'violet',
      items: [
        { title: 'RMIH Employee', desc: 'Check-in, requests, payslip, push notifications', href: '/docs#sdk-overview' },
        { title: 'RMIH Manager', desc: 'Team, schedules, tasks, approvals', href: '/docs#sdk-overview' },
  ...
  tr: [
    {
      ...
      color: 'emerald',
      items: [
        { title: 'Giriş', desc: 'RMIH genel bakış — Mobile-First Company OS', href: '/docs#intro' },
    ...
    },
    {
      ...
      color: 'violet',
      items: [
        { title: 'RMIH Employee', desc: 'Giriş, talepler, bordro, push bildirimleri', href: '/docs#sdk-overview' },
        { title: 'RMIH Manager', desc: 'Ekip, programlar, görevler, onaylar', href: '/docs#sdk-overview' },
  ...
  ar: [
    ...
    },
    {
      ...
      color: 'violet',
      items: [
        { title: 'RMIH Employee', desc: 'تسجيل الحضور والطلبات وكشف الراتب والإشعارات', href: '/docs#sdk-overview' },
        { title: 'RMIH Manager', desc: 'الفريق والجداول والمهام والموافقات', href: '/docs#sdk-overview' },
...
export const docsPageCopy: Record<AppLocale, DocsCopy> = {
  fr: {
    hero: {
      ...
      headlineHighlight: 'RMIH',
      subheadline: 'Guides, références API, webhooks et SDK pour intégrer RMIH à vos outils.',
    ...
    mobileInstallSection: {
      ...
      apps: [
        { name: 'RMIH Employee', desc: "Pointage mobile, géolocalisation, bulletins, demandes d'absence et notifications push.", href: '/signup?source=download_employee_android' },
        { name: 'RMIH Manager', desc: 'Équipe, horaires, tâches, approbations des demandes et paie simplifiée depuis le terrain.', href: '/signup?source=download_manager_android' },
        { name: 'RMIH Platform Admin', desc: 'Création de tenants, supervision des entreprises clientes et provisioning 2FA.', href: '/signup?source=download_platform-admin_android' },
      ],
  ...
  en: {
    hero: {
      ...
      headlineHighlight: 'RMIH',
      subheadline: 'Guides, API reference, webhooks and SDKs to integrate RMIH into your tools.',
    ...
    mobileInstallSection: {
      ...
      apps: [
        { name: 'RMIH Employee', desc: 'Mobile check-in, geolocation, payslips, leave requests and push notifications.', href: '/signup?source=download_employee_android' },
        { name: 'RMIH Manager', desc: 'Team, schedules, tasks, request approvals and simplified payroll from the field.', href: '/signup?source=download_manager_android' },
        { name: 'RMIH Platform Admin', desc: 'Tenant creation, supervision of client companies and 2FA provisioning.', href: '/signup?source=download_platform-admin_android' },
      ],
  ...
  tr: {
    hero: {
      ...
      headlineTop: 'Her şey',
      headlineHighlight: 'RMIH',
      subheadline: 'RMIH\'yi araçlarınıza entegre etmek için rehberler, API referansı, webhooklar ve SDK\'lar.',
    ...
    mobileInstallSection: {
      ...
      apps: [
        { name: 'RMIH Employee', desc: 'Mobil giriş, konum, bordrolar, izin talepleri ve push bildirimleri.', href: '/signup?source=download_employee_android' },
        { name: 'RMIH Manager', desc: 'Ekip, programlar, görevler, talep onayları ve sahada basitleştirilmiş maaş.', href: '/signup?source=download_manager_android' },
        { name: 'RMIH Platform Admin', desc: 'Kiracı oluşturma, müşteri şirketlerin denetimi ve 2FA sağlama.', href: '/signup?source=download_platform-admin_android' },
      ],
  ...
  ar: {
    ...
    mobileInstallSection: {
      ...
      apps: [
        { name: 'RMIH Employee', desc: 'حضور جوال وتحديد المواقع وكشوف رواتب وطلبات غياب وإشعارات فورية.', href: '/signup?source=download_employee_android' },
        { name: 'RMIH Manager', desc: 'الفريق والجداول والمهام وموافقات الطلبات ورواتب مبسطة من الميدان.', href: '/signup?source=download_manager_android' },
        { name: 'RMIH Platform Admin', desc: 'إنشاء المستأجرين والإشراف على الشركات العميلة وتجهيز 2FA.', href: '/signup?source=download_platform-admin_android' },
      ],
