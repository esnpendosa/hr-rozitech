...
export const integrationsByLocale: Record<AppLocale, { title: string; subtitle: string; badge: string; docsNote: string; statusLabels: { available: string; coming_soon: string }; categories: string[]; integrations: Integration[] }> = {
  fr: {
    title: 'Intégrations',
    subtitle: 'Connectez RMIH à vos outils existants',
    badge: 'Ecosysteme',
  ...
  en: {
    title: 'Integrations',
    subtitle: 'Connect RMIH to your existing tools',
    badge: 'Ecosystem',
  ...
  tr: {
    ...
    subtitle: 'RMIH yi kullandiginiz araclara baglayin',
    badge: 'Ekosistem',
  ...
  ar: {
    title: 'التكاملات',
    subtitle: 'اربط RMIH بأدواتك الحالية',
    badge: 'النظام البيئي',
