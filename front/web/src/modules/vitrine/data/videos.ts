...
export const videosPageCopy: Record<AppLocale, VideosContent> = {
  fr: {
    hero: {
      ...
      subheadline:
        'Découvrez RMIH en action à travers notre démo produit et nos tutoriels',
      ctaPrimary: 'Demander une démo live',
      ctaSecondary: 'Essai gratuit',
    },
    demo: {
      title: 'Présentation complète de RMIH',
      description:
        "Tour d'horizon de la plateforme — pointage, paie, absences, mobile et kiosk.",
      ariaLabel: 'Vidéo de présentation de RMIH',
      ...
      videos: [
        {
          ...
          description:
            'Connecter et configurer vos bornes biométriques ZKTeco avec RMIH.',
          category: 'Tutoriel',
        },
        {
        ...
        },
        {
          ...
          description:
            "Connecter RMIH à vos outils existants via l'API REST et les webhooks.",
    ...
    cta: {
      title: 'Prêt à voir RMIH en action ?',
  ...
  en: {
      ...
      videos: [
        {
          ...
          description:
            'Connect and configure your ZKTeco biometric terminals with RMIH.',
          category: 'Tutorial',
        },
        {
        ...
        },
        {
          ...
          description:
            'Connect RMIH to your existing tools via the REST API and webhooks.',
    ...
    cta: {
      title: 'Ready to see RMIH in action?',
  ...
  tr: {
      ...
      videos: [
        {
          ...
          description:
            'ZKTeco biyometrik terminallerinizi RMIH ile bağlayın ve yapılandırın.',
          category: 'Eğitim',
        },
        {
        ...
        },
        {
          ...
          description:
            'RMIH’i REST API ve webhook’lar aracılığıyla mevcut araçlarınıza bağlayın.',
    ...
    cta: {
      title: 'RMIH’i görmeye hazır mısınız?',
