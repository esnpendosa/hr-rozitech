...
const aboutByLocale: Record<AppLocale, AboutContent> = {
  ...
  fr: {
    ...
    story: {
      ...
      paragraphs: [
        "RMIH a été fondée en 2020 par Ahmed Benali, un entrepreneur passionné qui a constaté que les PME manquaient d'une solution RH complète et abordable. Après avoir géré les ressources humaines avec Excel pendant des années, il a décidé de créer une plateforme qui changerait tout.",
  ...
  en: {
    ...
    story: {
      ...
      paragraphs: [
        "RMIH was founded in 2020 by Ahmed Benali, a passionate entrepreneur who saw that SMEs lacked a complete, affordable HR solution. After years of managing human resources with Excel, he decided to build a platform that would change everything.",
  ...
  tr: {
    ...
    story: {
      ...
      paragraphs: [
        'RMIH, 2020 yılında, KOBİlerin eksiksiz ve uygun fiyatlı bir İK çözümünden yoksun olduğunu gören tutkulu bir girişimci olan Ahmed Benali tarafından kuruldu. Yıllarca Excel ile insan kaynaklarını yönettikten sonra her şeyi değiştirecek bir platform oluşturmaya karar verdi.',
