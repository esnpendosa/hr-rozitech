...
const featuresByLocale: Record<AppLocale, Feature[]> = {
  id: [
    {
      icon: Clock,
      title: 'Absensi Cerdas & Kehadiran',
      description: 'Pencatatan kehadiran presisi tinggi dengan dukungan mesin ZKTeco, QR Code, dan GPS mobile.',
      gradient: 'from-blue-500 to-indigo-600',
      stats: '4',
      statsLabel: 'Metode Presensi',
      details: ['Pengenalan Wajah', 'NFC / QR Code', 'Geolokasi GPS', 'Mode Offline'],
    },
    {
      icon: Users,
      title: 'Manajemen Cuti & Izin',
      description: 'Alur persetujuan terstruktur untuk pengajuan cuti, sakit, dan lembur dengan kalender bersama.',
      gradient: 'from-blue-400 to-indigo-500',
      stats: 'Real-Time',
      statsLabel: 'Saldo Cuti Karyawan',
      details: ['Saldo Otomatis', 'Persetujuan Bertingkat', 'Kalender Tim', 'Pengingat Otomatis'],
    },
    {
      icon: Wallet,
      title: 'Penggajian Otomatis (Payroll)',
      description: 'Penghitungan gaji otomatis sesuai komponen jam kerja dan slip gaji digital terstandar.',
      gradient: 'from-amber-400 to-orange-500',
      stats: '100% Rp',
      statsLabel: 'Mata Uang Rupiah',
      details: ['Mata Uang Rupiah (Rp)', 'Ekspor Laporan Pajak & Bank', 'Kasbon / Pinjaman Karyawan', 'Slip Gaji Instan'],
    },
    {
      icon: Shield,
      title: 'Keamanan Data Tingkat Tinggi',
      description: 'Autentikasi berlapis, enkripsi data end-to-end, dan pencatatan riwayat audit lengkap.',
      gradient: 'from-violet-400 to-purple-500',
      stats: 'Aman',
      statsLabel: 'Enkripsi Data',
      details: ['2FA', 'Enkripsi AES-256', 'Log Audit Aktivitas', 'Privasi Data Karyawan'],
    },
    {
      icon: Brain,
      title: 'Rozi AI',
      description: 'Asisten cerdas untuk menganalisis data personalia, mendeteksi anomali kehadiran, dan membantu keputusan.',
      gradient: 'from-fuchsia-400 to-pink-500',
      stats: 'Cerdas',
      statsLabel: 'Asisten Personalia',
      details: ['Analisis Prediktif', 'Laporan Cepat', 'Ringkasan Manajer', 'Rekomendasi Pintar'],
    },
    {
      icon: Smartphone,
      title: 'Mobile-First untuk Lapangan',
      description: 'Aplikasi nyaman di Android dan iOS dengan sinkronisasi instan dan mode offline siap pakai.',
      gradient: 'from-cyan-400 to-sky-500',
      stats: 'Android/iOS',
      statsLabel: 'Aplikasi Mobile',
      details: ['Aplikasi Karyawan', 'Mode Tanpa Internet', 'Notifikasi Cepat', 'Ramah di Lapangan'],
    },
  ],
  fr: [
    {
...
export function getFeatures(locale: AppLocale): Feature[] {
  return featuresByLocale[locale] ?? featuresByLocale.id
}
