 ...
 *
 * Corrigé au passage : le `<title>` incluait déjà « | RMIH » alors que
...
export const legalPageSeo: Record<'terms' | 'privacy', LegalSeo> = {
  terms: {
    ...
    description:
      "Conditions générales d'utilisation multilingues de RMIH pour les clients, administrateurs, managers, employés et intégrateurs.",
  },
  privacy: {
    title: 'Politique de confidentialité',
    description:
      'Politique de confidentialité multilingue de RMIH : données RH, conformité, droits des utilisateurs et sécurité.',
  },
};
