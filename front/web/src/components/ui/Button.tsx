...
const variantBase: Record<ButtonVariant, string> = {
  // Gradients blue (design system RMIH) — base commune, surchargeable
  ...
  outline: 'border border-slate-200 text-slate-700 hover:border-blue-300 hover:text-blue-700 disabled:opacity-60',
